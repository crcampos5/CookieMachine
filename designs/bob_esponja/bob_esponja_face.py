            ...
            for c in cnts:
                ...
                if area > 7000 and area < 2000000:
                    ...
                    if approx.shape[0] == 4:   
                        ...
                        return True , "Imagen analizada corretamente"
                        #cv.circle(img, (int(x),int(y)), 5, 255, 5)
                            #self.imagen.set(img)
                        #self.imagen.show()
                        #self.template = Template('bob_esponja_face')
            if contador == 0: return False , "No se encontraron galletas acordes a " + self.name
        else : return False , "No se encontraron galletas"
